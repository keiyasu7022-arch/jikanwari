...
export const initialTeachers: Teacher[] = [
  { id: "t1", name: "佐藤 健", hourlyWage: 2200, subject: "数学" },
  { id: "t2", name: "鈴木 一郎", hourlyWage: 2000, subject: "英語" },
  { id: "t3", name: "高橋 美咲", hourlyWage: 2400, subject: "国語" },
  { id: "t4", name: "田中 大輔", hourlyWage: 2100, subject: "理科" },
  { id: "t5", name: "伊藤 花子", hourlyWage: 1900, subject: "社会" },
];

export const initialStudents: Student[] = [
  { id: "s1", name: "山本 陽翔", grade: "中学2年" },
  { id: "s2", name: "中村 結菜", grade: "中学3年" },
  { id: "s3", name: "小林 蓮", grade: "小学6年" },
  { id: "s4", name: "加藤 咲良", grade: "中学1年" },
  { id: "s5", name: "吉田 大和", grade: "高校1年" },
  { id: "s6", name: "渡辺 心春", grade: "高校2年" },
  { id: "s7", name: "松本 悠斗", grade: "中学2年" },
  { id: "s8", name: "井上 陽菜", grade: "中学3年" },
];
